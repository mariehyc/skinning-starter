...
export class SkinningAnimation extends CanvasAnimation {
  ...
  private buildCylinderGeometry(mesh: Mesh): { positions: Float32Array; indices: Uint32Array } {
  ...
  public initCylinders(): void {
    ...
    this.cylinderRenderPass.addAttribute("vertPosition", 3, this.ctx.FLOAT, false,
      3 * Float32Array.BYTES_PER_ELEMENT, 0, undefined, cylinderMesh.positions);
  ...
  public initSkeleton(): void {
    ...
    this.skeletonRenderPass.addUniform("selectedBoneIndex",
      (gl, loc) => {
